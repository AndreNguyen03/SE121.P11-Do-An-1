...
function NFTCardProfile({ nft, onClick }) {
  ...
  return (
    <div onClick={handleWrapperClick} className="cursor-pointer w-[250px] h-[350px] rounded overflow-hidden m-2 bg-[#d8dfe7a5] text-white mx-auto shadow shadow-blue-500 transform hover:-translate-y-1 hover:scale-105 transition-transform duration-200 ease-in-out">
      ...
      <div className="p-2 pb-4 space-y-2">
        ...
        <div className='flex justify-between items-center pt-5'>
          ...
          {!nft.isListed && <Button bg="bg-blue-800" textColor="text-white" btnText={"List"} className="min-w-fit px-6 text-sm" onClick={(e) => {
