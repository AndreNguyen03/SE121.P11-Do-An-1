...
function Navbar() {
  return (
    <nav className='fixed flex justify-between items-center w-full drop-shadow-xl border-b-4 p-4 px-6 lg:px-12 z-50'>
        <Link to="/">
        ...
        <div>
            <div className='text-black hidden lg:flex gap-4 items-center font-medium'>
